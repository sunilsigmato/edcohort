...
$(function(){
    ...
    function excel_html_handler(data){
        ...
        if(data.compare_duplicates.total > 0){
            $(".e-b-p-area").show();
            $(".e-b-p span").html(data.compare_duplicates.total);
            insert_values_to_db($(".e-b-p-area").find(".e-b-p-t"),data.compare_duplicates.data);
        }
