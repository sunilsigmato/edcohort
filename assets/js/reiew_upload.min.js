...
$(function(){
    ...
    $('body').on('change', "input.file-activity", function() {
        ...
        S_Data =0;
                    ...
                    $.ajax({
                        url: base_url+"admin_review/import_ajax_save",
                        data: formData,
                        processData: false,
                        contentType: false,
                        type: 'POST',
    ...
    function call_processing_area(yx,res){
        ...
        $.ajax({
                        url: base_url+"admin_review/read_excel_values",
                        data: {ajax:1,
    ...
    function validate_and_processs_to_db(yx,data){
        ...
        yx.find('.myprogress').css('width', '100%');
         ...
         $.ajax({
                        url: base_url+"admin_review/push_excel_values_db",
                        data:data,
                        type: 'POST',
