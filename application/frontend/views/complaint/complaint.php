...
<div class="content">
 ...
 <!-- </button> -->
  ...
  <li class="list-group-item d-flex">
                ...
                <div class="review-center">
                    ...
                    <div class="review-inner-center">
                        <div class="tab-link">
                            <ul>
                                <li>
                                    <a href="<?php echo base_url(); ?>complaint?course=<?php echo $course; ?>&segment=<?php echo $segment; ?>"
                                        class="active">All</a>
                                </li>
                                <?php if ($this->session->userdata('user_id')) { ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>my-complaint?course=<?php echo $course; ?>&segment=<?php echo $segment; ?>">My
                                        Complaint</a>
                                </li>
                                <?php } else { ?>
                                <li>
    ...
    <div class="total-review">{{total_items}} Complaint</div>
