        ...
        <div class = "col-md-2 pt-1">
            ...
            <div class="col-md-4 pt-3 write-review-icon ">
                ...
                <?php if ($this->session->userdata('user_id')) { ?>
                            <a href="<?php echo base_url();?>create-cohort?course=<?php echo @$course; ?>&segment=<?php echo $segment;?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>"
