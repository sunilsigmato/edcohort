    ...
    $(document).ready(function() {
        ...
        $('input[name="customer_rating"]').change(function(){
            if($(this).is(':checked')){
                 ...
                 location.reload();
                 window.location="<?php echo base_url();?>my-review/?course="+parameter_course+"&segment="+filter_segment_id+"&sort_by="+sort_by+"&customer_rating="+ratings;
         ...
         $('input[name="sort_by"]').change(function(){
            if($(this).is(':checked')){
                ...
                location.reload();
               // console.log("Selected rating: " + ratingValue);
              window.location="<?php echo base_url();?>my-review/?course="+parameter_course+"&segment="+filter_segment_id+"&sort_by="+sort_by;
              //location.reload();
            }
        });
