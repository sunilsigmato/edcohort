    ...
    <div class="col-md-3 breadcrumb-design">
        <div class="breadcrumb">
            <ul>
                ...
                <li><a href="<?php echo base_url(); ?>my-review?segment=<?php echo $segment_temp; ?>"> My Review</li>
                    ...
                    <div class=" d-flex flex-wrap justify-content-between ">
                        <div class="tab-link">
                            <ul>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>my-review?segment=<?php echo $segment_temp; ?>" class="active">My
                                        Review</a>
                                </li>
                                <?php } else {  ?>
                                <li>
    ...
    <div class=" d-flex flex-wrap justify-content-between align-items-center">
        ...
        <?php
            ...
            { ?>
                    {{#xif user_like "==" "1"}}    
                    <a href="javascript:void(0)"
                        onclick="productReviewLike({{product_review_id}},'<?php echo $this->session->userdata('user_id'); ?>','0')">
