      ...
      <div class="row narrow-content">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
          <div class="product-gallery vertical-pager1">
            <ul>
              ...
              <li class="mySlides easyzoom easyzoom--overlay easyzoom--with-thumbnails"
                id="slides_<?php echo $count; ?>" style="height: 400px;">
                <a href="<?php echo $value; ?>">
                  <img src="<?php echo $value; ?>" alt="<?php echo $records['0']->product_name;  ?>" width="100%"
                    height="100%" />
                </a>
              </li>
              <?php $count++; } ?>
            ...
            <div id="bx-pager" class="product-gallery_preview">
              <?php $count=0; foreach ($image_array as $key => $value) { ?>
              <a href="javascript:void(0)"><img src="<?php echo $value; ?>"
                  onclick="showSlides('<?php echo $count; ?>')" alt="<?php echo $records['0']->product_name;  ?>" /></a>
              <?php $count++; } ?>
              <?php foreach ($video_array as $key => $value) { ?>
              <a href="javascript:void(0)"><img src="<?php echo base_url(); ?>assets/360_degree.jpg"
                  onclick="showSlides('<?php echo $count; ?>')" width="" height="" title="Video"
        ...
        <div class="product-cart product-details-narrow col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
          <div class="product-options_header clearfix wow fadeInUp" data-wow-delay="0.3s">
            ...
            <h3 class="font-additional font-weight-bold text-uppercase">Style#
              <?php if($records['0']->product_sku != ""){ echo $records['0']->product_sku; }  ?> </h3>
            <img src="<?php echo base_url(); ?>assets/images/back-icon.png" alt="Back"
              class="my-tooltip my-dropdown pull-right" data-toggle="modal" data-target=""
              onclick="window.history.back()" data-placement="top" title="Back" data-tooltip="true">
          ...
          <div class="product-options_body clearfix wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="product-options_desc font-main color-third">
              <?php if($records['0']->product_short_description != ""){ echo $records['0']->product_short_description; }  ?>
            ...
            <form action="" id="cart_form" class="form-horizontal">
              <input type="hidden" id="cart_product_id" name="cart_product_id"
                value="<?php echo $records['0']->product_id; ?>">
              ...
              <div class="quantity buttons_added"
                style="display: <?php if($product_maximum_quantity==1){ echo 'none'; } ?>">
                <button type="button" class="minus cart_quantity" id="cart_quantity_minus"><i
                    class="fa fa-minus"></i></button>
                <input type="text" step="1" min="<?php echo $product_minimum_quantity; ?>"
                  max="<?php echo $product_maximum_quantity; ?>" name="quantity" id="cart_quantity" readonly=""
                  value="1" title="Qty" class="input-text qty text" size="1">
                <button type="button" class="plus cart_quantity" id="cart_quantity_plus"><i
          ...
          <div class="product-options_cart clearfix wow fadeInUp" data-wow-delay="0.3s" style="padding-bottom: 10px;">
            ...
            <div class="" style="display: inline-block;">
              <a href="javascript:void(0)" onclick="add_cart('<?php echo $records['0']->product_id; ?>',this)"
                class="btn button-additional button-big font-additional font-weight-normal text-uppercase hvr-rectangle-out hover-focus-bg before-bg">
                <span class="fa fa-shopping-cart" aria-hidden="true"></span> Add To Cart</a>
            </div>
            <?php }?>
            <?php if($records['0']->product_is_get_quote=="1"){ ?>
            <div class="" style="display: inline-block;">
              <a href="javascript:void(0)" onclick="get_quote_modal('<?php echo $records['0']->product_id; ?>',this)"
                class="btn button-additional button-big font-additional font-weight-normal text-uppercase hvr-rectangle-out hover-focus-bg before-bg">
            ...
            <div class="" style="margin-top: 13px;">
              <ul class="product-links" style="padding-bottom: 0">
                <?php if($records['0']->product_is_price=="1"){ ?>
                <li>
                  <a href="javascript:void(0)" onclick="add_wish('<?php echo $records['0']->product_id; ?>',this)"
                    class="font-additional font-weight-normal hover-focus-color">
                    <span aria-hidden="true" class="fa fa-heart"></span> Add To Wishlist</a>
                </li>
                <li>
                  <a href="#" data-toggle="modal" data-target="#myModaljewelry"
                    class="font-additional font-weight-normal hover-focus-color">
                    <span class="fa fa-envelope" aria-hidden="true"></span>
                    email to friend
                  </a>
                </li>
                <li> <a href="javascript:void(0);" onclick="print_detail('<?php echo $records['0']->product_id; ?>')">
                    <span class="fa fa-print" aria-hidden="true"></span>Print Details </a> </li>
                <li> <a href="javascript:void(0);" onclick="add_compare('<?php echo $records['0']->product_id; ?>')">
                    <span class="fa fa-exchange" aria-hidden="true"></span> Compare</a> </li>
                <?php } ?>
                <li> <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalappointment"
                    class="font-additional font-weight-normal hover-focus-color"> <span class="fa fa-clock-o"
      ...
      <div class="modal-dialog">
        <div class="modal-content radius-flat">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url(); ?>get-quote-jewelry" method="post" onsubmit="overlay()"
              id="get_quote_form" class="form-horizontal contact-form form-design">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="product_id" value="<?php echo $records['0']->product_id; ?>" />
              <div class="form-group">
                <label class="col-md-3"> Name :</label>
                <div class="col-md-9">
                  <input type="text" class="form-control radius-flat" name="name" placeholder="Name" required="required"
                    autofocus="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="email" class="form-control radius-flat" name="email" placeholder="Email"
                    required="required">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control radius-flat" name="phone" onkeypress="" maxlength="12"
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <textarea class="form-control textarea-contact radius-flat" rows="5" name="comment"
                    placeholder="Type Your Message/Feedback here..."></textarea>
                </div>
              </div>
              <button class="btn btn-primary radius-flat" onclick="get_quote()" type="button"> <span
      ...
      <div class="modal-dialog">
        <div class="modal-content radius-flat">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url('emailus-jewelry') ?>" method="post" onsubmit="overlay()"
              id="emailus_form1" class="form-horizontal contact-form form-design">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="product_id" value="<?php echo $records['0']->product_id; ?>" />
              <div class="form-group">
                <label class="col-md-3"> Name :</label>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content radius-flat">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url(); ?>email-jewelry-details" method="post" onsubmit="overlay()"
              id="email_form1" class="form-horizontal contact-form form-design">
              <?php echo csrf_field(); ?>
              <input type="hidden" name="product_id" value="<?php echo $records['0']->product_id; ?>" />
              <div class="form-group">
                <label class="col-md-3">Name :</label>
              ...
              <div class="form-group">
                <label class="col-md-3">Phone :</label>
                <div class="col-md-9">
                  <input type="text" class="form-control radius-flat" name="phone" maxlength="10"
                    placeholder="Mobile No." required="required">
                </div>
              </div>
              <div class="form-group">
      ...
      <div class="modal-dialog">
        <div class="modal-content radius-flat">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url('appointment-form') ?>" method="post" onsubmit="overlay()"
              id="appointment_form1" class="form-horizontal contact-form form-design">
              <div class="form-list">
                <?php echo csrf_field(); ?>
                <div class="form-schedule">
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input name="firstname" class="input-text required-entry name form-control radius-flat"
                  ...
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input name="lastname" class="input-text required-entry name form-control radius-flat"
                          required="required" placeholder="Last Name*" type="text">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="form-schedule">
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input name="email"
                          class="input-text required-entry email validate-email form-control radius-flat"
                          required="required" placeholder="Email*" type="email">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input name="phone"
                          class="input-text telephone validate-phoneLax required-entry form-control radius-flat"
                          required="required" placeholder="Phone*" type="text">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="form-schedule">
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="dropdown form-group">
                      ...
                      <div class="col-md-9">
                        <select name="time" class="required-entry validate-select form-control radius-flat"
                          required="required" id="dropdownval">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input name="date" id="datepicker"
                          class="validate-date input-text date_from required-entry form-control radius-flat"
                          required="required" placeholder="Preferred Date*" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      <label class="col-md-3"> Comment :</label>
                      <div class="col-md-9">
                        <textarea type="text" name="comment" class="input-text comment form-control radius-flat"
                          placeholder="Comments" style="height:80px;"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="button-set">
                  <button class="btn btn-primary radius-flat" value="" type="submit"> <span class="fa fa-send"></span>
                    Send </button>
                </div>
              </div>
            </form>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-12 clearfix no-padding-left">
        ...
        <div class="links">
          <div class="link-wrapper">
            <a rel="nofollow" data-fallback-url="" href="tel:<?php echo SITE_PHONE ?>"
              style="display: inline-table;padding-right: 15px"><i
                class="fa fa-phone"></i><span><?php echo SITE_PHONE ?></span></a>
            <a data-email-address="<?php echo SITE_EMAIL ?>" data-toggle="modal" data-target="#myModaljewelryinquiry"
              style="cursor:pointer; display: inline-table;"><i class="fa fa-envelope"></i><span>Email Us</span></a>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12 col-12 clearfix border-left">
        <div class="product-options_row">
          ...
          <ul class="social-list">
            <li><a href="javascript:void(0)" class="hover-focus-border hover-focus-bg hvr-rectangle-out before-bg"
                id="fb_share"><span class="fa fa-facebook" aria-hidden="true"></span></a></li>
            <li><a href="javascript:void(0)" class="hover-focus-border hover-focus-bg hvr-rectangle-out before-bg"
                id="tw_tweet"><span class="fa fa-twitter" aria-hidden="true"></span></a></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="tabs-panel" role="tabpanel">
        <ul class="nav-tabs wow fadeInUp" data-wow-delay="0.3s" role="tablist">
          ...
          <li role="presentation" class="active">
            <a class="hover-focus-border hover-focus-bg font-additional font-weight-normal hvr-rectangle-out before-bg"
              href="#reviews" aria-controls="profile" role="tab" data-toggle="tab">REVIEWS
              (<?php echo ($review_count) ? $review_count : 0 ;  ?>)</a>
          </li>
        </ul>
        <div class="tab-content no-padding-top wow fadeInUp" data-wow-delay="0.3s">
          ...
          <div id="reviews" class="tab-pane fade in active" role="tabpanel">
            ...
            <div>
              <div>
                <span class="rewiew_name"><strong><i class="fa fa-user-circle-o"></i>
                    <?php echo $prkey->firstname." ".$prkey->lastname; ?> </strong></span> Gave
                ...
                <span class="rewiew_date"><strong> <?php echo date('d-M-Y',strtotime($prkey->product_review_added)); ?>
                  </strong></span>
              </div>
              <div>
            ...
            <div><a class="btn btn-danger radius-flat pull-right"
                href="<?php echo base_url(); ?>product-review/<?php echo $records['0']->product_slug; ?>">See More
                Review</a></div>
            <?php } ?>
            ...
            <div class="col-md-offset-2 col-lg-offset-2 col-sm-offset-1 col-md-8 col-lg-8 col-sm-10 col-12">
              <form action="<?php echo base_url(); ?>send-product-review" method="post" class="form-horizontal">
                  ...
                  <div class="col-md-12">
                    <ul class="star_list">
                      <li><span> 5 Star </span><label for="rating_star_5" class="active_rating">
                          <input type="radio" id="rating_star_5" name="review_rating[]" value="5" checked=""
                            style="opacity: 0">
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <input type="text" class="form-control radius-flat" id="review_title" name="review_title"
                      placeholder="Review Tag Line" required="">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-12">
                    <textarea class="form-control radius-flat" name="review_content" id="review_content" cols="30"
            ...
            <?php }else { ?>
            <a class="btn btn-primary radius-flat"
              href="<?php echo base_url(); ?>login?referer=<?php echo urlencode(base_url().'product-review/'.$records['0']->product_slug); ?>">Write
              Review</a>
            <?php } ?>
          </div>
        </div>
  ...
  <section id="slider" class="slider-products padding-two">
    <div class="container">
      <div class="starSeparatorBox clearfix">
        ...
        <h3 class="title font-additional text-uppercase wow zoomIn no-padding-top padding-two" data-wow-delay="0.3s">
          Similar Products</h3>
        <div id="" class="owl-carousel owl-carousel-engagement">
          ...
          <div class="product-col product-space item position-relative product-overlay">
            ...
            <div class="card-body">
              <h4 class="card-title">
                <a href="<?php echo base_url(); ?>jewelry-details/<?php echo $row->product_slug; ?>">Style#
                  <?php if($row->product_sku!=""){ echo $row->product_sku;} ?></a>
              </h4>
  ...
  <script type="text/javascript">
    ...
    $(document).on("click", "#fb_share", function (e) {
      window.open("https://www.facebook.com/sharer/sharer.php?u=" + shared_url, "MsgWindow",
        "width=500, height=500,resize-able=yes");
    });
    $(document).on("click", "#tw_tweet", function (e) {
      window.open("https://twitter.com/intent/tweet?url=" + shared_url + "&text=platinumdays", "MsgWindow",
        "width=500, height=500,resize-able=yes");
    });
  </script>
  <script>
